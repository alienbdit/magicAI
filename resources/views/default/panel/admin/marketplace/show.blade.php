                ...
                >
										...
										@else
											<span class="lqd-tooltip-container group relative inline-flex cursor-default before:absolute before:-start-1.5 before:-top-1.5 before:h-7 before:w-7">
													...
													>
                                                           ...
                                                           <span class="flex justify-center mt-1">info@liquid-themes.com <x-tabler-copy class="ms-2" id="copyButton" /></span>
					...
					@else
						<x-button
							class="w-full"
							size="lg"
							href="https://mobile.magicproject.ai/ "
						>
							{{ __('Live Preview') }}
						</x-button>
					@endif
